...
export default function Layout() {
  ...
  const showRoutes = {
    menu: ['/', '/help', '/friends', '/games', '/createpost', '/profile/', '/postdetails/', '/personalprofile', '/information', '/premium', '/favorites'],
    header: ['/', '/help', '/friends', '/games', '/createpost', '/profile/', '/postdetails/', '/personalprofile', '/information', '/premium', '/favorites'],
  };
